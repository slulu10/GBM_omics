...
##for CD4 analysis, we added the proliferative T cells to increase the number of cells

prefix = "Monocle.CD4T"
infile = "Lymphoid_TcellOnlyWithProlif.ForMonocle.rds"
...
#Exprlist = gbm.combined@assays$RNA@counts["CD14",]
...
## no myeloid  no CD8 with  CD3 & CD4
...
Brc=c(1,2,9,5,7,8)
BrcName=factor(c("1","2","9","5","7","8"),levels=c("1","2","9","5","7","8"))
```
...
Plot specific genes related to known CD4 populations
```{r}
gene_to_cluster <- c("PDCD1","GZMB",
            "CCL5",
            "CX3CR1","LAG3",
            "TOX","TNFRSF9",
